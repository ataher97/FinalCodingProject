...
public class TestPMT {
	...
	public static double[] buttonAction(double dLoanAmount, double dInterestRate, int dNbrOfYears, LocalDate localDate,
			double dAddPayment) {
		...
		double[] answer = { TotalPayments, TotalInterest, dNbrOfYears };
		return answer;
	}
